    ...
    return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 h-screen place-items-center font-bold">
            ...
            <div className="flex flex-col w-full">
                ...
                <input type="text" id="nome" name="nome" placeholder="Nome" className="border-3 border-orange-800 rounded-full p-2 focus:border-orange-400 focus:outline text-orange-800" />
            </div>

            <div className="flex flex-col w-full">
                <label htmlFor="usuario" className="px-5 text-orange-800 text-xl">Usuário</label>
                <input type="text" id="usuario" name="usuario" placeholder="Usuário" className="border-3 border-orange-800 rounded-full p-2 focus:border-orange-400 focus:outline text-orange-800" />
            </div>

            <div className="flex flex-col w-full">
                <label htmlFor="foto" className="px-5 text-orange-800 text-xl">Foto</label>
                <input type="text" id="foto" name="foto" placeholder="Foto" className="border-3 border-orange-800 rounded-full p-2 focus:border-orange-400 focus:outline text-orange-800" />
            </div>

            <div className="flex flex-col w-full">
                <label htmlFor="senha" className="px-5 text-orange-800 text-xl">Senha</label>
                <input type="password" id="senha" name="senha" placeholder="Senha" className="border-3 border-orange-800 rounded-full p-2 focus:border-orange-400 focus:outline text-orange-800" />
            </div>

            <div className="flex flex-col w-full">
                <label htmlFor="connfirmarSenha" className="px-5 text-orange-800 text-xl">Confirmar senha</label>
                <input type="password" id="connfirmarSenha" name="connfirmarSenha" placeholder="Confirmar senha" className="border-3 border-orange-800 rounded-full p-2 focus:border-orange-400 focus:outline text-orange-800" />
            </div>
